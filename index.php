        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Background/book_hands_reading_134405_3840x2400.jpg" class="d-block w-100 carrousel-img" alt="...">
                ...
                <div class="carousel-item">
                    <img src="img/Background/books_library_reading_211249_1280x720.jpg" class="d-block w-100 carrousel-img" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="img/Background/joel-muniz-XqXJJhK-c08-unsplash.jpg" class="d-block w-100 carrousel-img" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    ...
                    ?>
                        <div class="col">
                            <div class="card box">
                                ...
                                <a href="produto.php?id=<?= $livro['id'] ?>" class="preco text-decoration-none fs-5 fw-bold text-dark mb-3">
